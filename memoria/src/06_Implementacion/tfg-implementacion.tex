...
\begin{itemize}
	...
	\begin{itemize}
		\item \textbf{../application/resteasy/application. } Directorio con las clases necesarias para la conversión de objetos a persistentes a objetos de transferencia de datos.
		\item \textbf{../application/resteasy/spring. } Directorio con las clases necesarias para la creación del objeto persistente a modificar a partir del objeto de transferencia de datos recibido. 
		\item \textbf{../application/resteasy/util. } Directorio en el que se encuentran clases que ofrecen funcionalidades como la conversión de excepciones \textit{Java} a respuestas \textit{Http}, validadores de datos de entrada, etc...
	\end{itemize}
\end{itemize}
