...
Tras reconocer las necesidades del sistema, se ha optado por diseñar un sistema general compuesto por los diferentes subsistemas del mismo.
...
\includegraphics[
   keepaspectratio=true
]{./04_Analisis/img/uc__Sistema-General.png}
...
\includegraphics[
   keepaspectratio=true
]{./04_Analisis/img/Sistema-Acceso.png}
...
\includegraphics[
   keepaspectratio=true
]{./04_Analisis/img/Sistema-Aplicacion-Movil.png}
...
\includegraphics[
   keepaspectratio=true
]{./04_Analisis/img/Sistema-Aplicacion-Web.png}
...
\includegraphics[
   keepaspectratio=true
]{./04_Analisis/img/Sistema-Administracion.png}
...
\includegraphics[
   keepaspectratio=true
]{./04_Analisis/img/Sistema-Gestion-Usuarios.png}
...
\includegraphics[
   keepaspectratio=true
]{./04_Analisis/img/Sistema-Gestion-Rutas.png}
...
\includegraphics[
   keepaspectratio=true
]{./04_Analisis/img/Sistema-Gestion-Visitas.png}
...
\includegraphics[
   keepaspectratio=true
]{./04_Analisis/img/Sistema-Gestion-Lugares.png}
...
\includegraphics[
   keepaspectratio=true
]{./04_Analisis/img/Sistema-Gestion-Eventos.png}
...
\includegraphics[
   keepaspectratio=true
]{./04_Analisis/img/Sistema-Gestion-Categorias.png}
...
\item[2.] El usuario no tiene permisos necesarios para realizar determinada acción.
	...
	\item[1.] El sistema muestra un mensaje de error indicando que no está autorizado a realizar dicha acción.
	\end{itemize}
\item[2.] La visita que quiere eliminar no se encuentra en el sistema.
	\begin{itemize}
	\item[1.] El sistema muestra un mensaje de error indicando que no es posible realizar la acción.
	\end{itemize}
\item[2.] La ruta se encuentra finalizada.
	\begin{itemize}
	\item[1.] El sistema muestra un mensaje de error indicando que no es posible realizar la acción.
	\end{itemize}
\end{enumerate}
