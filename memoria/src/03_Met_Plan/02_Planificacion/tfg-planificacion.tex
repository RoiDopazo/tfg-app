...
En el diagrama se puede observar la duración, la fecha de comienzo y de fin para el proyecto entero. Se muestra también la división y planificación del mismo en las diferentes iteraciones definidas previamente. Para cada iteración, también se puede observar la planificación realizada.

En los siguiente diagramas se mostrará la planificación de las tareas para cada una de las iteraciones, en las que se podrá observar los recursos asignados encargados de realizar dicha tarea.
...
Analista & 18 €/h & 98 &  1.764 €  \\ \hline
Programador & 16 €/h & 488 & 7.808 €  \\ \hline
\textbf{Total} & & & \textbf{10.332 €} \\ \hline
\end{tabular}
