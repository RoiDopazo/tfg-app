...
Cada ciclo consta de cuatro fases: \textbf{Inicio}, \textbf{Elaboración}, \textbf{Construcción} y \textbf{Transiciçon}. Cada fase se divide en iteraciones, en las cuales se desarrollo secuencialemte una serie de disciplinas o flujos de trabajo, donde los más importantes son: \textit{Análisis, Diseño, Implementación y Pruebas.}
...
El objetivo de esta fase es ayudar al equipo de proyecto a decidir cuales son los verdaderos objetivos del proyecto. Las iteraciones 

\subsection{Fase de elaboración}
En esta se especifican la mayoría de los casos de uso del producto y se diseña la arquitectura del mismo. Se establece una firme comprensión del problema a solucionar.
