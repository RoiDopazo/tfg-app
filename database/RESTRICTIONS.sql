...
ALTER TABLE PLACE_COMMENT ADD CONSTRAINT FK_USER_PLACE_COMMENT FOREIGN KEY (USER_X_USER) REFERENCES USER_(X_USER);
...
ALTER TABLE USER_PLACE ADD CONSTRAINT FK_USER_USER_PLACE FOREIGN KEY (USER_X_USER) REFERENCES USER_(X_USER);
...
ALTER TABLE ROUTE_DAY ADD CONSTRAINT FK_STAY_ROUTE_DAY FOREIGN KEY (STAY_X_STAY) REFERENCES STAY(X_STAY);

ALTER TABLE ROUTE_DAY ADD CONSTRAINT FK_REAL_TIME_DATA FOREIGN KEY (RDATA_X_RDATA) REFERENCES REAL_TIME_DATA(X_RDATA);
